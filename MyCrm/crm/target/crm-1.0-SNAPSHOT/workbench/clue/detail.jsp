	...
	$(function(){
        ...
        $("#searchByAName").keydown(function (event) {
            ...
            if(event.keyCode == 13){
                //展现市场活动列表
                $.ajax({
                    url:"workbench/clue/getAListNotLinkedClueId.do",
                    data:{
                    ...
                    success:function (data) {
                        ...
                        $("#searchByActivityNameBody").html(html);
                    }
                })
        ...
        $("#searchByActivityNameBody").on("click",$("input[name=ck]"),function () {
            $("#allChecked").prop("checked",$("input[name=ck]").length == $("input[name=ck]:checked").length);
        })

        //为关联按钮绑定事件，执行关联列表的添加操作
        $("#bundBtn").click(function () {
            ...
            if($ck.length ==0){
                ...
                $.ajax({
                    url:"workbench/clue/bundClueAndActivity.do",
                    data:param,
                    type:"post",
                    dataType:"json",
                    success:function (data) {
...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<table id="activityTable" class="table table-hover" style="width: 900px; position: relative;top: 10px;">
						...
						<tbody id="searchByActivityNameBody">
                                <%--动态生成--%>
						</tbody>
					</table>
				</div>
	...
	<div>
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div>
				<a data-toggle="modal" data-target="#bundModal" id="openRelation" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>
