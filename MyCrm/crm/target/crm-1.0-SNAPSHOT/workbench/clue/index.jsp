...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#clueBody").on("click",$("input[name=ck]"),function () {
	...
	function pageList(pageNo,pageSize) {
		...
		$("#hidden-mphone").val($.trim($("#search-mphnone").val()));
	    ...
	    $.ajax({
            ...
            data:{
                ...
                "mphone":$.trim($("#search-mphnone").val()),
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<label for="create-states" class="col-sm-2 control-label">线索状态</label>
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-states">
								  <option></option>
									<%--使用jstl语法从application域中遍历数据--%>
				...
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" type="text" id="search-mphnone">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
					  ...
					  <select class="form-control" id="search-state">
					  	<option></option>
                          <%--使用jstl语法从application域中遍历数据--%>
                          <c:forEach items="${clueStateList}" var="sl">
